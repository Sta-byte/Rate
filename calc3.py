...
if 3 / 2 == 1:
    input: Union[Callable[[Any], str], Any] = raw_input

print('Welcome to this calculator!')
print('It can add, subtract, multiply and divide whole numbers from 0 to 10')
num1 = int("Please choose your first number: ")
sign = 'What do you want to do? +, -, /, or *: '
num2 = int("Please choose your second number: ")
