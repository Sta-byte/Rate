...
for row in my_table.findAll('tr'):
    ...
    if(len(row_data) > 0):
        ...
        df2['TotalCases'] = pd.to_numeric(df2['TotalCases'].astype(int), errors='coerce')
        df2['NewCases'] = pd.to_numeric(df2['NewCases'].astype(int), errors='coerce')
        df2['TotalDeaths'] = pd.to_numeric(df2['TotalDeaths'].astype(int), errors='coerce')
        df2['NewDeaths'] = pd.to_numeric(df2['NewDeaths'].astype(int), errors='coerce')
        df2['TotalRecovered'] = pd.to_numeric(df2['TotalRecovered'].astype(int), errors='coerce')
        df2['ActiveCases'] = pd.to_numeric(df2['ActiveCases'].astype(int), errors='coerce')
        df2['CriticalCases'] = pd.to_numeric(df2['CriticalCases'].astype(int), errors='coerce')
        df2['infection_rate'] = pd.to_numeric(df2['infection_rate'].astype(int), errors='coerce')
